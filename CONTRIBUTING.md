...
We have adopted a [Code of Conduct](https://github.com/ciklum-digital/xmess/blob/master/CODE_OF_CONDUCT.md) that we expect project participants to adhere to. Please read the full text so that you can understand what actions will and will not be tolerated.
...
We are using [GitHub Issues](https://github.com/ciklum-digital/xmess/issues) for bug tracing. Please, use [template](https://github.com/ciklum-digital/xmess/tree/master/.github/ISSUE_TEMPLATE) for issue/feature creating.
...
1. Open a new issue in the [issues tracker](https://github.com/ciklum-digital/xmess/issues)
...
1. For PR creation use [template]([template](https://github.com/ciklum-digital/xmess/tree/master/.github/PULL_REQUEST_TEMPLATE.md))
